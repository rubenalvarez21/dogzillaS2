...
#ifndef DOG_JOINT_INTERFACES__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
#define DOG_JOINT_INTERFACES__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
...
/// Initialize srv/SetJointPosition message.
/**
...
/// Finalize srv/SetJointPosition message.
/**
...
/// Create srv/SetJointPosition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dog_joint_interfaces__srv__SetJointPosition_Request__init().
...
/// Destroy srv/SetJointPosition message.
/**
 * It calls
 * dog_joint_interfaces__srv__SetJointPosition_Request__fini()
...
/// Check for srv/SetJointPosition message equality.
/**
...
/// Copy a srv/SetJointPosition message.
/**
...
/// Initialize array of srv/SetJointPosition messages.
/**
...
/// Finalize array of srv/SetJointPosition messages.
/**
 * It calls
 * dog_joint_interfaces__srv__SetJointPosition_Request__fini()
...
/// Create array of srv/SetJointPosition messages.
/**
 * It allocates the memory for the array and calls
 * dog_joint_interfaces__srv__SetJointPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetJointPosition messages.
/**
 * It calls
 * dog_joint_interfaces__srv__SetJointPosition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetJointPosition message array equality.
/**
...
/// Copy an array of srv/SetJointPosition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dog_joint_interfaces__srv__SetJointPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_joint_interfaces
...
/**
 * It calls
 * dog_joint_interfaces__srv__SetJointPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_joint_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dog_joint_interfaces__srv__SetJointPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_joint_interfaces
...
/**
 * It calls
 * dog_joint_interfaces__srv__SetJointPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOG_JOINT_INTERFACES__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
