...
#include "dog_joint_interfaces/msg/detail/motor_angle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dog_joint_interfaces::msg::MotorAngle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dog_joint_interfaces::msg::MotorAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dog_joint_interfaces::msg::MotorAngle *>(
    untyped_ros_message);
...
{
  return &dog_joint_interfaces::msg::typesupport_fastrtps_cpp::_MotorAngle__handle;
}
