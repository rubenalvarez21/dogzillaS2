...
class Metaclass_SetJointPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dog_joint_interfaces.srv.SetJointPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dog_joint_interfaces.srv import _set_joint_position
...
class SetJointPosition(metaclass=Metaclass_SetJointPosition):
    from dog_joint_interfaces.srv._set_joint_position import SetJointPosition_Request as Request
    from dog_joint_interfaces.srv._set_joint_position import SetJointPosition_Response as Response
